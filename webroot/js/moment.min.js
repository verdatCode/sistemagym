...
hooks.defineLocale('gu', {
    ...
    longDateFormat : {
        ...
        L : 'DD/MM/YYYY',
        LL : 'D MMMM YYYY',
        LLL : 'D MMMM YYYY, A h:mm સમય',
        LLLL : 'dddd, D MMMM YYYY, A h:mm સમય'
    },
    calendar : {
        sameDay : '[આજે] LT',
        nextDay : '[આવતીકાલે] LT',
...
hooks.defineLocale('ta', {
    ...
    longDateFormat : {
        ...
        L : 'DD/MM/YYYY',
        LL : 'D MMMM YYYY',
        LLL : 'D MMMM YYYY, A h:mm நேரம்',
        LLLL : 'dddd, D MMMM YYYY, A h:mm நேரம்'
    },
    calendar : {
        sameDay : '[இன்று] LT',
        nextDay : '[நாளை] LT',
    ...
    meridiemHour : function (hour, meridiem) {
        ...
        if (meridiem === 'இரவு') {
            return hour < 4 ? hour : hour + 12;
        } else if (meridiem === 'காலை பொழுதில்') {
            return hour;
        } else if (meridiem === 'மதியம்') {
            return hour >= 10 ? hour : hour + 12;
        } else if (meridiem === 'சாயங்காலம்') {
            return hour + 12;
        }
    },
    meridiem : function (hour, minute, isLower) {
...
hooks.defineLocale('te', {
    ...
    weekdaysShort : 'ఆది_సోమ_మంగళవారం_మెడ్_గురు_గురు_శుక్ర_శని'.split('_'),
    weekdaysMin : 'ఆది_సోమ_మంగళవారం_మెడ్_గురు_గురు_శుక్ర_శని'.split('_'),
    longDateFormat : {
        LT : 'A h:mm సమయం',
        LTS : 'A h:mm:ss సమయం',
        L : 'DD/MM/YYYY',
        LL : 'D MMMM YYYY',
        LLL : 'D MMMM YYYY, A h:mm సమయం',
        LLLL : 'dddd, D MMMM YYYY, A h:mm సమయం'
    },
    calendar : {
        sameDay : '[ఈరోజు] LT',
        nextDay : '[రేపు] LT',
...
hooks.defineLocale('mr', {
    ...
    weekdaysShort : 'रवि_सोम_मंगळवार_म बुध_गुरुवार_शुक्र_शनि'.split('_'),
    ...
    longDateFormat : {
        ...
        L : 'DD/MM/YYYY',
        LL : 'D MMMM YYYY',
        LLL : 'D MMMM YYYY, A h:mm वेळ',
        LLLL : 'dddd, D MMMM YYYY, A h:mm वेळ'
    },
    calendar : {
        sameDay : '[आज] LT',
        nextDay : '[આવતીકાલે] LT',
...
hooks.defineLocale('kn', {
    ...
    weekdaysShort : 'ಸೂರ್ಯ_ಸೋಮ_ಮಂಗಳವಾರ_ಎಂ ಬುಧವಾರ_ಗುರುವಾರ_ಶುಕ್ರ_ಶನಿ'.split('_'),
    weekdaysMin : 'ಸೂರ್ಯ_ಸೋಮ_ಮಂಗಳವಾರ_ಎಂ ಬುಧವಾರ_ಗುರುವಾರ_ಶುಕ್ರ_ಶನಿ'.split('_'),
    longDateFormat : {
        LT : 'A h:mm ಸಮಯ',
        LTS : 'A h:mm:ss ಸಮಯ',
        L : 'DD/MM/YYYY',
        LL : 'D MMMM YYYY',
        LLL : 'D MMMM YYYY, A h:mm ಸಮಯ',
        LLLL : 'dddd, D MMMM YYYY, A h:mm ಸಮಯ'
    },
    calendar : {
        sameDay : '[ಇಂದು] LT',
        nextDay : '[ನಾಳೆ] LT',
    ...
    meridiemHour : function (hour, meridiem) {
        ...
        if (meridiem === 'ರಾತ್ರಿ') {
            return hour < 4 ? hour : hour + 12;
        } else if (meridiem === 'ಮುಂಜಾನೆಯಲ್ಲಿ') {
            return hour;
        } else if (meridiem === 'ಮಧ್ಯಾಹ್ನದಲ್ಲಿ') {
            return hour >= 10 ? hour : hour + 12;
...
hooks.defineLocale('bn', {
    ...
    weekdaysShort : 'সূর্য_সোম_মঙ্গলবার_ম বুধ_বৃহস্পতি_শুক্র_শনি'.split('_'),
    weekdaysMin : 'সূর্য_সোম_মঙ্গলবার_ম বুধ_বৃহস্পতি_শুক্র_শনি'.split('_'),
    longDateFormat : {
        LT : 'A h:mm সময়',
        LTS : 'A h:mm:ss সময়',
        L : 'DD/MM/YYYY',
    ...
    meridiemHour : function (hour, meridiem) {
        ...
        if (meridiem === 'রাত্রি') {
            return hour < 4 ? hour : hour + 12;
        } else if (meridiem === 'সকালে') {
            return hour;
        } else if (meridiem === 'বিকালে') {
            return hour >= 10 ? hour : hour + 12;
...
hooks.defineLocale('ur', {
    ...
    meridiemHour : function (hour, meridiem) {
        ...
        if (meridiem === 'ରାତି') {
            return hour < 4 ? hour : hour + 12;
        } else if (meridiem === 'ସକାଳେ') {
            return hour;
        } else if (meridiem === 'ଉପରବେଳା ରେ') {
            return hour >= 10 ? hour : hour + 12;
...
hooks.defineLocale('zu', {
    ...
    longDateFormat : {
        ...
        L : 'DD/MM/YYYY',
        LL : 'D MMMM YYYY',
        LLL : 'D MMMM YYYY, A h:mm Isikhathi',
        LLLL : 'dddd, D MMMM YYYY, A h:mm Isikhathi'
    },
    calendar : {
        sameDay : '[Namuhla] LT',
        nextDay : '[kusasa] LT',
    ...
    // Hindi notation for meridiems are quite fuzzy in practice. While there exists
    // a rigid notion of a 'Pahar' it is not used as rigidly in modern Hindi.
    meridiemParse: /Ebusuku | ekuseni | ntambama | kusihlwa/,
    meridiemHour : function (hour, meridiem) {
        if (hour === 12) {
            hour = 0;
        }
        if (meridiem === 'Ebusuku') {
            return hour < 4 ? hour : hour + 12;
        } else if (meridiem === 'Ebusuku') {
            return hour;
        } else if (meridiem === 'Emini') {
            return hour >= 10 ? hour : hour + 12;
        } else if (meridiem === 'Kusihlwa') {
            return hour + 12;
        }
    },
    meridiem : function (hour, minute, isLower) {
...
hooks.defineLocale('no', {
    ...
    longDateFormat : {
        ...
        L : 'DD/MM/YYYY',
        LL : 'D MMMM YYYY',
        LLL : 'D MMMM YYYY, A h:mm Tid',
        LLLL : 'dddd, D MMMM YYYY, A h:mm Tid'
    },
    calendar : {
        sameDay : '[I dag] LT',
        nextDay : '[i morgen] LT',
    ...
    meridiemHour : function (hour, meridiem) {
        ...
        if (meridiem === 'Natt') {
            return hour < 4 ? hour : hour + 12;
        } else if (meridiem === 'Om morgenen') {
            return hour;
        } else if (meridiem === 'På ettermiddagen') {
            return hour >= 10 ? hour : hour + 12;
        } else if (meridiem === 'Kveld') {
            return hour + 12;
        }
    },
    meridiem : function (hour, minute, isLower) {
