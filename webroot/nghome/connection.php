...
$password = "";
$dbname="gym_master";
$server_path = 'http://localhost/nilkanth/gym_master_/';
$image_path='http://localhost/nilkanth/gym_master/webroot/upload/';
$image_pa=$image_path;
	...
	function custom_http_response_code($code = NULL)
	{
		if ($code !== NULL)
		{
			switch ($code)
			{
				...
				case 303: $text = 'Username and Email alredy exist'; break;
