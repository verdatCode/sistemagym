...
<ul class="sidebar-menu">
	...
	<li class="treeview <?php echo ($this->request->controller == "Sunat") ? "active" : ""; ?>">
		<a href="<?php echo $this->Gym->createurl("sunat", "boleta"); ?>">
			<i class="far fa-envelope"></i> <span><?php echo __("Sunat"); ?></span><i class="fa fa-angle-left pull-right"></i>
		</a>
		<ul class="treeview-menu">
			<li class="<?php echo ($this->request->action == "boleta") ? "active" : ""; ?>">
				<a href="<?php echo $this->Gym->createurl("sunat", "boleta"); ?>">
					<i class="fa fa-circle-o"></i> <span><?php echo __('Boleta'); ?></span></i>
				</a>
			</li>
			<li class="<?php echo ($this->request->action == "factura" || $this->request->action == "addIncome" || $this->request->action == "incomeEdit") ? "active" : ""; ?>">
				<a href="<?php echo $this->Gym->createurl("sunat", "factura"); ?>">
					<i class="fa fa-circle-o"></i><?php echo __('Factura'); ?>
				</a>
			</li>
			<li class="<?php echo ($this->request->action == "expenseList" || $this->request->action == "addExpense" || $this->request->action == "expenseEdit") ? "active" : ""; ?>">
				<a href="<?php echo $this->Gym->createurl("MembershipPayment", "expenseList"); ?>">
