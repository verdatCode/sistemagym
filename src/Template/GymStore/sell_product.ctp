...
<section class="content">
	...
	<div class="col-md-12 box box-default">		
		...
		<div class="col-md-6">
			<input type="text" autocomplete="off" name="sell_date" class="sell-date form-control validate[required]" value="<?php echo ($edit)?date($this->Gym->getSettings("date_format"),strtotime($data["sell_date"])) : "";?>">
		</div>	
		</div>
		<div class='form-group'>	
