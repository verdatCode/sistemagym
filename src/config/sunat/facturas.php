...
class Facturas
{
    ...
    const TIPO_COMPROBANTE = '01'; // Código para factura
     ...
     */
    public function facturaEstructuraData(array $data): array
    {
        Log::info("Generando estructura de factura: " . $data['idfactura']);
                    ...
                    "cac:Party" => [
                        "cac:PartyIdentification" => [
                            "cbc:ID" => [
                                ...
                                "_text" => $data['rucCliente']
                            ]
                        ],
                        "cac:PartyLegalEntity" => [
                            "cbc:RegistrationName" => [
                                "_text" => $data['razonSocialCliente']
                            ],
                            "cac:RegistrationAddress" => [
                                "cac:AddressLine" => [
                                    "cbc:Line" => [
                                        "_text" => $data['direccionCliente']
                                    ]
                                ]
                            ]
                        ]
